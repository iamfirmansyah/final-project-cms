                            ...
                            <div id="myTabContent" class="tab-content custom-product-edit">
                                <div class="product-tab-list tab-pane fade active in" id="description">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <div class="review-content-section">
                                                <div class="input-group mg-b-pro-edt">
                                                    ...
                                                    <input type="text" name="name" class="form-control" value="{{ $product->name }}" placeholder="Product Title" required>
                                                </div>
                                                <div class="input-group mg-b-pro-edt">
                                                    <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                    <input type="number" class="form-control" placeholder="Price" name="price" value="{{ $product->price }}" required>
                                                </div>
                                                <div class="input-group mg-b-pro-edt">
                                                    <span class="input-group-addon"><i class="icon nalika-new-file" aria-hidden="true"></i></span>
                                                    <input type="file" accept="image/*" id="imgInp" class="form-control" placeholder="Image" name="image" required>
                                                    <input type="text" hidden value="{{ $product->image }}" name="old_image">
                                                </div>
                                                <select name="status" class="form-control pro-edt-select form-control-primary" required>
                                                    <option value="opt1">Select Status</option>
                                                    <option value="stock" selected @if ($product->status == 'stock')
                                                        selected
                                                    @endif>In Stock</option>
                                                    <option value="out_stock" @if ($product->status == 'out_stock')
                                                        selected
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <div class="review-content-section">
                                                <img id="blah" src="{{ asset('products-assets/' . $product->image) }}" alt="" width="400"/>
                                            </div>
                                        </div>
                                    </div>
